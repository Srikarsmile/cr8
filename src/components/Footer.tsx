        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              Build skills. Access opportunities. Create your path.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <Link href="/pathways/digital-creative" className="hover:text-white transition-colors">
                  Digital &amp; Creative
                </Link>
              </li>
              <li>
                <Link href="/pathways/beauty" className="hover:text-white transition-colors">
                  Beauty
                </Link>
              </li>
              <li>
                <Link href="/pathways/construction" className="hover:text-white transition-colors">
                  Construction
                </Link>
              </li>
              <li>
                <Link href="/entrepreneurship" className="hover:text-white transition-colors">
                  Entrepreneurship
                </Link>
              </li>
              <li>
                <Link href="/soft-life-loading" className="hover:text-white transition-colors">
                  Soft Life Loading
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-6">
              &copy; {new Date().getFullYear()} CRE8 Pathways. All rights reserved.
            </p>
          </div>
        </div>
      </div>
